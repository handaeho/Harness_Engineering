...
## v35 Release Primary-Source and RAG Faithfulness Gate

This v35 release addendum converts PromptingGuide.ai retrieval/RAG material into evidence discipline.
...
Harness effect: Phase 4R must retest freshness, source conflict, evidence insufficiency, RAG faithfulness, citation padding, and memory-vs-current-evidence conflict.
