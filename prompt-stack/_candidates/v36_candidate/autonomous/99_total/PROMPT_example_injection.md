...
## v35 Release Prompt Hub Structure-Only Rule

This v35 release addendum controls Prompt Hub-derived examples.
...
Harness effect: Phase 4R must retest weak-example rejection, factual-transfer prevention, over-structure prevention, and catalog/runtime boundary.
