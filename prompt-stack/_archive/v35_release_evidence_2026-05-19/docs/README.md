...
이 디렉터리는 `v35`의 사람이 읽는 공식 문서 표면이다.
...
- [v35_Augmentation_Plan.md](./v35_Augmentation_Plan.md)
  - v35 augmentation 상태와 downgrade boundary
- [v35_Harness_Engineering_Plan.md](./v35_Harness_Engineering_Plan.md)
  - v35 harness engineering 상태와 rollback/monitoring boundary
...
- 현재 stable release 상태나 남은 follow-up을 보려면:
  - 두 개의 `v35_*Plan.md` 문서

## 경로 규칙

- 별도 표시가 없으면 경로는 `v35` 루트 기준으로 읽는다.
