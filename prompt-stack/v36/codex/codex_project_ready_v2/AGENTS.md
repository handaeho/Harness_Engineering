...
For coding, refactoring, tests, API contracts, data contracts, and Java/Python implementation work, also follow `.codex/ENGINEERING_CONVENTION.md`.

If `.codex/ENGINEERING_CONVENTION.md` conflicts with this `AGENTS.md`, this `AGENTS.md` wins.
