...
for rel in [
    '.codex/ENGINEERING_CONVENTION.md',
...
if '.codex/ENGINEERING_CONVENTION.md' not in agents_text:
    errors.append('AGENTS.md does not reference .codex/ENGINEERING_CONVENTION.md')
if '.codex/ENGINEERING_CONVENTION.md' not in coding_text:
    errors.append('coding-core does not reference .codex/ENGINEERING_CONVENTION.md')
