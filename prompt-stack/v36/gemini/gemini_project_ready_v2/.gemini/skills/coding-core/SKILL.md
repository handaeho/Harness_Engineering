...
Before changing code, tests, API contracts, message contracts, or code-adjacent documentation, check and follow `.gemini/ENGINEERING_CONVENTION.md` when it exists. If it conflicts with `GEMINI.md`, `GEMINI.md` wins.
