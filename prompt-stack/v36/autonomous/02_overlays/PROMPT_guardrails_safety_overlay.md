...
## active package Release PromptingGuide Risk Mapping

This active package release addendum maps PromptingGuide.ai risk material into enforceable safety behavior.
...
Harness effect: replay evaluation must keep critical-failure override semantics for injection, leaking, jailbreak, secret, approval bypass, destructive operations, and safe/unsafe mixed requests.
