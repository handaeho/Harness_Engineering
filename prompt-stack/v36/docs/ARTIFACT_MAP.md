...
## Evidence package
`_evidence/v36/`는 active runtime package가 아니다. 다음 category를 보존한다.
...
- cleanup evidence: `_evidence/v36/cleanup_records/`, `_evidence/v36/cleanup_reports/`

## Root-level preserved packages
- active package: `v36/`
- evidence package: `_evidence/v36/`
- candidate evidence source: `_candidates/v36_candidate/`
