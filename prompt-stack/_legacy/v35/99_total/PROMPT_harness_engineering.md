...
이 문서는 `v35`의 `harness engineering` 공식 prompt-stack layer owner 문서다.
...
`v35`는 harness doctrine를 다음 Runtime OS layer로 읽을 수 있어야 한다.
...
## v35 Release Substrate Readiness Matrix

This v35 release addendum separates substrate readiness.
