...
- control-packet family completeness support
...
11. The task needs a compact control artifact for monitoring, recovery, budgeting, prioritization, discovery frontier management, capability handoff, capability contract, evidence boundary, or memory scope packaging.
...
### 26.11 For monitoring, recovery, budget, priority, frontier, or handoff artifacts, prefer a local control packet over a heavy global skeleton
