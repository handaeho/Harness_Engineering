...
- compact control packets such as `Tool capability contract / precondition memo`, `Evidence target / retrieval-mode memo`, or `Memory scope / checkpoint profile memo` when those boundaries materially govern the task
