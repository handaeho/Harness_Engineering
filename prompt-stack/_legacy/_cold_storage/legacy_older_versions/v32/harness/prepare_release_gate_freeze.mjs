...
const v32Root = path.join(repoRoot, "prompt-stack", "v32");
const harnessRoot = path.join(v32Root, "harness");

const rawArgs = process.argv.slice(2);
let freezeId = "rg-2026-05-06-a";
...
const promptRoots = [
  path.join(v32Root, "01_base"),
  path.join(v32Root, "02_overlays"),
  path.join(v32Root, "03_examples"),
  path.join(v32Root, "codex")
];
...
promptFiles.push(path.join(v32Root, "AGENTS.md"));
promptFiles.sort();
...
const manifest = {
  ...
  freeze_scope: {
    prompt_surface: [
      "prompt-stack/v32/AGENTS.md",
      "prompt-stack/v32/01_base/*",
      "prompt-stack/v32/02_overlays/*",
      "prompt-stack/v32/03_examples/*",
      "prompt-stack/v32/codex/**"
    ],
    harness_assets: [
      "prompt-stack/v32/harness/scenarios.json",
      "prompt-stack/v32/harness/response_schema.json",
      "prompt-stack/v32/harness/run_external_harness.mjs",
      "prompt-stack/v32/harness/run_release_gate_repeats.mjs",
      "prompt-stack/v32/harness/release_gate_policy.json"
    ]
  },
