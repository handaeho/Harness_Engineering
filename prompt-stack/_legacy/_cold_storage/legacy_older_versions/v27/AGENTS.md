...
### 16.2 v26 executable-proof rule
...
### 16.3 v27 operational-evidence rule
...
- if multiple artifacts must be synthesized, keep one explicit join rule for precedence, reconciliation, and downgrade behavior
...
- keep failure classes such as stale context, ignored critique, no-gain loop, rollback, false promotion, false hold, drift-triggered review, rollback aftermath, and route-switch failure independently diagnosable
