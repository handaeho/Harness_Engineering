...
- keep linked identifiers stable across benchmark, replay, adaptation, release, and telemetry packet families when example structure is used for those artifacts
