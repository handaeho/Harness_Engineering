...
- keep `run_id`, `cohort_id`, or equivalent linkage visible when adaptation evidence depends on repeated judged outcomes
...
- keep `rollback aftermath`, `quarantine entry`, and `false-hold` conditions independently visible rather than collapsing them into generic adaptation caution
