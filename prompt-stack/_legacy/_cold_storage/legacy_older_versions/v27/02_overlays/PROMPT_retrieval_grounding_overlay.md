...
- keep evidence-pack failure, provenance defect, and freshness defect independently visible rather than smoothing them into generic retrieval weakness
- if repeated context defects are claimed, preserve a stable run or cohort linkage so the defect can be reviewed longitudinally
