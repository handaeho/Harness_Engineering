...
- keep tool-run linkage stable with `run_id` or equivalent identifiers whenever replay, coding-proof, release, or telemetry packets depend on the same execution
