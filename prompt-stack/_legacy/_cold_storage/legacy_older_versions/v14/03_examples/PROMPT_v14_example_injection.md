...
- **Document Name**: `PROMPT_v14_example_injection`
- **Version**: `v14`
- **Role**: Example-layer runtime controller
- **Primary Function**: Control whether, when, and how examples from `PROMPT_v14_example_catalog` are used to shape response structure.
- **Controller Scope**:
  - example activation
...
- **Non-Function**:
  ...
  - This document does not store immutable example bodies. That belongs to `PROMPT_v14_example_catalog`.
...
- `PROMPT_v14_example_catalog` = immutable structural data
- `PROMPT_v14_example_injection` = selection + evaluation + adaptation + safety controller
...
- whether the task is closer to direct answer, workflow artifact, multimodal artifact, or evaluation artifact
