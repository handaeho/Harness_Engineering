...
- **Document Name**: `PROMPT_v14_example_catalog`
- **Version**: `v14`
...
- **Ownership Rule**:
  ...
  - Runtime example control belongs only to **`PROMPT_v14_example_injection`**.
...
- A verification pattern is static metadata that may be interpreted by `PROMPT_v14_example_injection` or a base prompt.
...
- `PROMPT_v14_example_catalog` is **immutable structural data**
- `PROMPT_v14_example_injection` is the **selection + evaluation + adaptation + safety controller**
