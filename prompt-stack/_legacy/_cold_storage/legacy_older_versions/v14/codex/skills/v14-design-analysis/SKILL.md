...
- `PROMPT_v14_full`
- `PROMPT_v14_search_reasoning_overlay`
- `PROMPT_v14_retrieval_grounding_overlay`
- selected `PROMPT_v14_multi_agent_overlay` principles for bounded specialist decomposition
