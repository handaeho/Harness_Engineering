...
- `PROMPT_v14_tool_protocol_overlay`
- `PROMPT_v14_example_injection`
- coding-relevant entries from `PROMPT_v14_example_catalog`

It should preserve the load-bearing semantics of the v14 stack without becoming a repo-wide rewrite engine.
