...
- keep guide / runtime / skill lookup parity visible for goal, recovery, approval, budget, and prioritization packets; do not let one layer silently know a family the others no longer expose
