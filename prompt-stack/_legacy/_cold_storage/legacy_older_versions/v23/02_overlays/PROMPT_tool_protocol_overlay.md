...
- Source consultation ledger when tool-mediated research blends public and private sources or when consulted-source groups must remain inspectable after a long-running retrieval path
