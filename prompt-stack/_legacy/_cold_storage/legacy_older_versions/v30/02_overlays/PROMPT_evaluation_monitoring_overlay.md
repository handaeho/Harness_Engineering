...
- if operational artifacts are absent, downgrade gate confidence before release, promotion, or drift escalation
- keep `false-promotion`, `false-hold`, and `drift-triggered review` as separately reviewable failure outcomes when promotion or monitoring decisions are being judged
