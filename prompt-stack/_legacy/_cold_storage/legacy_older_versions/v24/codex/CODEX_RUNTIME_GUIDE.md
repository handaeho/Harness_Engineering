...
- keep coding-briefing, research-transparency, resource-concurrency, packet-compliance, replay-review, and release-evidence packets equally visible when those are the live control boundaries
