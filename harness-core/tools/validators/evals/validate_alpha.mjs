...
check("release_gate.yaml validates and blocks forbidden claims", () => {
  ...
  validateWithSchema(ajv, loadSchema(p("schemas", "release_gate.schema.json")), gate, "release/gates/core-release/release_gate.yaml");
...
const report = {
  ...
  errors,
  runner_reexecution: {
    reference_baseline_runners_reexecuted: false,
...
- reference baseline runners re-executed: false
`;
