...
export function validatePlan(options = {}) {
  ...
  for (const relPath of [
    "release/scopes/beta/beta_dedicated_containment_verification_plan_scope.yaml",
    "release/gates/containment/dedicated_containment_verification_gate.yaml",
  ...
  addCheck(checks, "future execution runner not created in plan stage", !exists("tools/runners/security/run_dedicated_containment_verification.mjs")
