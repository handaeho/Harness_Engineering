...
function writeStaticArtifacts() {
  writeRelText("release/post_rc_production_monitoring_window_result_review_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_result_claim_boundary.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_final_gate_preconditions.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_result_blocker_update.yaml", `stage: ${STAGE}
status: updated
...
forbidden_execution:
  ...
  production_deployment: true
gate:
  script: tools/check_post_rc_production_monitoring_window_result_review.mjs
`);

  writeRelText("docs/production_monitoring_window_result_review.md", `# Production Monitoring Window Result Review
...
`);
  ...
  writeRelText("docs/production_monitoring_final_gate_preconditions.md", `# Production Monitoring Final Gate Preconditions
...
`);
  ...
  writeRelText("docs/next_production_monitoring_final_gate_plan.md", `# Next Production Monitoring Final Gate Plan
