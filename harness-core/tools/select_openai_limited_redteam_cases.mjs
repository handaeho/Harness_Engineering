...
function writePolicyFiles() {
  writeYaml("release/beta_openai_redteam_limited_execution_plan_scope.yaml", {
    stage: STAGE,
    approved_actions: {
  ...
  writeYaml("release/openai_redteam_limited_execution_gate.yaml", {
    stage: STAGE,
  ...
  writeYaml("release/redteam_provider_execution_blocker_update.yaml", {
    blocker_id: "RGB-003",
...
function writeDocs(selectedTotal) {
  const docs = {
    "docs/openai_redteam_limited_execution_plan.md": `# OpenAI Redteam Limited Execution Plan
...
`,
    "docs/openai_redteam_case_selection_policy.md": `# OpenAI Redteam Case Selection Policy
...
`,
    "docs/openai_redteam_execution_guard.md": `# OpenAI Redteam Execution Guard
...
`,
    "docs/openai_redteam_cost_and_stop_criteria.md": `# OpenAI Redteam Cost And Stop Criteria
...
`,
    "docs/next_openai_redteam_limited_execution.md": `# Next OpenAI Redteam Limited Execution
