...
addCheck(checks, "command plan is not executable in this stage",
  commandPlan?.command_plan?.stage_to_execute_after_operator_values === "v2.0.0-post-rc-production-monitoring-window-execution"
    ...
    && commandPlan?.command_plan?.commands?.includes("node harness-core/tools/run_post_rc_production_monitoring_window.mjs")
    && commandPlan?.command_plan?.commands?.includes("node harness-core/tools/check_post_rc_production_monitoring_window.mjs"), {
