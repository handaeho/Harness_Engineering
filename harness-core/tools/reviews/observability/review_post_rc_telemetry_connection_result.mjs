...
function writeStaticArtifacts() {
  writeRelText("release/scopes/post-rc/post_rc_telemetry_connection_result_review_scope.yaml", `stage: ${REVIEW_STAGE}
...
`);
  ...
  writeRelText("release/gates/post-rc/post_rc_telemetry_connected_claim_gate.yaml", `stage: ${REVIEW_STAGE}
...
forbidden_execution:
  ...
  telemetry_sink_additional_write: true
gate:
  script: tools/checks/observability/check_post_rc_telemetry_connection_result_review.mjs
required_artifacts:
...
`);
  ...
  writeRelText("docs/claims/telemetry_connected_claim_boundary.md", `# Telemetry-Connected Claim Boundary
