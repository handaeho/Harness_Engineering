...
const docs = {
  "docs/local/openai_redteam_limited_result_review.md": reviewMd,
  "docs/claims/openai_redteam_limited_claim_boundary.md": `${claimAuditMd}

Still not allowed:

${markdownList(claimsNotAllowed)}
`,
  "docs/plans/next_release_blocker_resolution_plan.md": `# Next Release Blocker Resolution Plan
