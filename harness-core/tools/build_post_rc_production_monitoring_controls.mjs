...
function writeStaticReleaseArtifacts() {
  writeRelText("release/post_rc_production_monitoring_controls_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_gate.yaml", `stage: ${STAGE}
status: designed
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_claim_boundary.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_blocker_update.yaml", `stage: ${STAGE}
...
forbidden_execution:
  ...
  telemetry_sink_write: true
gate:
  script: tools/check_post_rc_production_monitoring_controls.mjs
required_artifacts:
...
function writeDocs() {
  writeRelText("docs/production_monitoring_controls.md", `# Production Monitoring Controls
...
`);
  ...
  writeRelText("docs/production_monitoring_dashboard_spec.md", `# Production Monitoring Dashboard Spec
...
`);
  ...
  writeRelText("docs/production_monitoring_alerting_policy.md", `# Production Monitoring Alerting Policy
...
`);
  ...
  writeRelText("docs/production_monitoring_anomaly_thresholds.md", `# Production Monitoring Anomaly Thresholds
...
`);
  ...
  writeRelText("docs/production_monitoring_window_policy.md", `# Production Monitoring Window Policy
...
`);
  ...
  writeRelText("docs/production_monitoring_incident_response.md", `# Production Monitoring Incident Response
...
`);
  ...
  writeRelText("docs/production_monitoring_rollback_linkage.md", `# Production Monitoring Rollback Linkage
...
`);
  ...
  writeRelText("docs/next_production_monitoring_window_plan.md", `# Next Production Monitoring Window Plan
...
const controls = {
  ...
  production_monitoring_gate_defined: exists("release/post_rc_production_monitoring_gate.yaml")
};
