...
const REQUIRED_REL_PATHS = [
  "release/post_export_provider_verified_coverage_preflight_scope.yaml",
  "release/post_export_provider_verified_coverage_matrix.yaml",
  "release/post_export_provider_verified_claim_boundary.yaml",
  "release/post_export_provider_verified_blocker_update.yaml",
  ...
  "docs/provider_verified_coverage_preflight.ko.md",
  "docs/provider_verified_coverage_matrix.ko.md",
  "docs/provider_verified_missing_coverage.ko.md",
  "docs/next_provider_verified_final_gate_plan.ko.md",
  "docs/next_adapter_checked_coverage_plan.ko.md",
  "tools/assess_post_export_provider_verified_coverage_preflight.mjs",
  "tools/audit_post_export_provider_verified_claim_boundary.mjs",
  "tools/check_post_export_provider_verified_coverage_preflight.mjs"
];
