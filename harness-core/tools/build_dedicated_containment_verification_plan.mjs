...
function commandPlanYaml() {
  ...
  commands:
    - node harness-core/tools/run_dedicated_containment_verification.mjs
    - node harness-core/tools/check_dedicated_containment_verification.mjs
...
function readmeText() {
  return buildMarkdown("HARNESS Core", [
    ...
    "",
    "```powershell",
    "node harness-core/tools/check_dedicated_containment_verification_plan.mjs",
    "```",
    "",
...
function handoffText(report) {
  return buildMarkdown("Session Handoff - 2026-05-22", [
    ...
    "",
    "- `node harness-core/tools/build_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node harness-core/tools/validate_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node harness-core/tools/check_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node harness-core/tools/validate_alpha.mjs`: pass.",
    "- `node harness-core/tools/scan_prohibited_claims.mjs`: pass, matches 0.",
    "- `node harness-core/tools/check_reference_baseline_integrity.mjs`: pass.",
    "",
