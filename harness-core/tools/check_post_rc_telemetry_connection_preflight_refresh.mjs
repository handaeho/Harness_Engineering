...
function yamlCommandPlanHasFutureOnly(relPath) {
  ...
  return plan?.not_executable_in_preflight_refresh_stage === true
    ...
    && plan.commands.includes("node harness-core/tools/run_post_rc_telemetry_connection.mjs")
    && plan.commands.includes("node harness-core/tools/check_post_rc_telemetry_connection.mjs");
}
