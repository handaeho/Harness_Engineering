...
function writeStaticArtifacts() {
  writeRelText("release/post_rc_production_monitoring_window_execution_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_claim_boundary.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_blocker_update.yaml", `stage: ${STAGE}
status: updated
...
forbidden_execution:
  ...
  production_deployment: true
gate:
  script: tools/check_post_rc_production_monitoring_window.mjs
expected_status: monitoring_window_incomplete
`);

  writeRelText("docs/production_monitoring_window_execution.md", `# Production Monitoring Window Execution
...
`);
  ...
  writeRelText("docs/next_production_monitored_final_gate_plan.md", `# Next Production-Monitored Final Gate Plan
