...
for (const relPath of [
  "release/post_rc_production_monitoring_controls_scope.yaml",
  "release/post_rc_production_monitoring_gate.yaml",
  "release/post_rc_production_monitoring_claim_boundary.yaml",
  ...
  "docs/production_monitoring_controls.md",
  "docs/production_monitoring_dashboard_spec.md",
  "docs/production_monitoring_alerting_policy.md",
  "docs/production_monitoring_anomaly_thresholds.md",
  "docs/production_monitoring_window_policy.md",
  "docs/production_monitoring_incident_response.md",
  "docs/production_monitoring_rollback_linkage.md",
  "docs/next_production_monitoring_window_plan.md",
