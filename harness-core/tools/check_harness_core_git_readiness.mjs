...
addCheck(checks, "commit approval request exists", fs.existsSync(p("release/harness_core_git_commit_approval_request.md")), {
  path: "release/harness_core_git_commit_approval_request.md"
});
