...
for (const relPath of [
  "release/gates/post-rc/post_rc_production_monitoring_readiness_gate.yaml",
  ...
  "docs/observability/production_monitoring_readiness.md",
  "docs/observability/production_monitoring_remaining_controls.md",
  "docs/plans/next_production_monitoring_gate_plan.md",
