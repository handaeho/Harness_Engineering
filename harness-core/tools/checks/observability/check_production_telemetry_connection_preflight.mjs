...
const approvalGate = exists("release/gates/telemetry/production_telemetry_connection_approval_gate.yaml")
...
for (const relPath of [
  "release/scopes/beta/beta_production_telemetry_connection_preflight_scope.yaml",
  ...
  "release/blockers/telemetry/telemetry_connection_blocker_update.yaml",
