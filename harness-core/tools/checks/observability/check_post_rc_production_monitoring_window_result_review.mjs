...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_production_monitoring_window_result_review_scope.yaml",
  "release/claims/post-rc/post_rc_production_monitoring_window_result_claim_boundary.yaml",
  "release/gates/post-rc/post_rc_production_monitoring_final_gate_preconditions.yaml",
  "release/blockers/post-rc/post_rc_production_monitoring_window_result_blocker_update.yaml",
  "tools/reviews/observability/review_post_rc_production_monitoring_window_result.mjs",
  "tools/checks/observability/check_post_rc_production_monitoring_window_result_review.mjs",
  "tools/audits/observability/audit_post_rc_production_monitoring_window_result_claims.mjs",
  ...
  "docs/observability/production_monitoring_window_result_review.md",
  "docs/observability/production_monitoring_final_gate_preconditions.md",
  "docs/plans/next_production_monitoring_final_gate_plan.md"
];
