...
for (const relPath of [
  "release/scopes/post-rc/post_rc_telemetry_connection_result_review_scope.yaml",
  "release/gates/post-rc/post_rc_telemetry_connected_claim_gate.yaml",
  ...
  "docs/claims/telemetry_connected_claim_boundary.md"
]) {
