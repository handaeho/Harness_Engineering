...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_production_monitoring_window_execution_scope.yaml",
  "release/claims/post-rc/post_rc_production_monitoring_window_claim_boundary.yaml",
  "release/blockers/post-rc/post_rc_production_monitoring_window_blocker_update.yaml",
  "tools/runners/observability/run_post_rc_production_monitoring_window.mjs",
  "tools/checks/observability/check_post_rc_production_monitoring_window.mjs",
  "tools/audits/observability/audit_post_rc_monitoring_window_claims.mjs",
  ...
  "docs/observability/production_monitoring_window_execution.md",
  "docs/observability/production_monitoring_window_result_review.md",
  "docs/plans/next_production_monitored_final_gate_plan.md"
];
