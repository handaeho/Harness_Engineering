...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_production_monitoring_window_continuation_checkpoint_scope.yaml",
  "release/gates/post-rc/post_rc_production_monitoring_window_continuation_gate.yaml",
  "release/blockers/post-rc/post_rc_production_monitoring_window_continuation_blocker_update.yaml",
  "tools/checkpoints/observability/checkpoint_post_rc_production_monitoring_window.mjs",
  "tools/checks/observability/check_post_rc_production_monitoring_window_continuation.mjs",
  ...
  "docs/observability/production_monitoring_window_continuation_checkpoint.md",
  "docs/observability/production_monitoring_window_remaining_requirements.md",
  "docs/plans/next_monitoring_window_result_review_plan.md"
];
