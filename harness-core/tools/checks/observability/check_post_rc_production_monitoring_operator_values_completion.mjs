...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_production_monitoring_operator_values_completion_scope.yaml",
  "release/gates/post-rc/post_rc_production_monitoring_window_execution_approval_gate.yaml",
  "release/approvals/post-rc/post_rc_production_monitoring_window_execution_approval_request.md",
  ...
  "docs/approvals/production_monitoring_operator_values_completion.md",
  "docs/approvals/production_monitoring_window_execution_approval_request.md",
...
const approvalRequest = exists("release/approvals/post-rc/post_rc_production_monitoring_window_execution_approval_request.md")
...
addCheck(checks, "operator values match provided values",
  operatorValues?.operator_values?.status === "complete"
    && operatorValues?.operator_values?.dashboard?.langfuse_project_name === "harness-core-post-rc"
