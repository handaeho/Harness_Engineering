...
const REQUIRED_FILES = [
  "release/gates/post-rc/post_rc_production_monitoring_final_gate_scope.yaml",
  "release/gates/post-rc/post_rc_production_monitoring_final_gate.yaml",
  "release/claims/post-rc/post_rc_production_monitored_claim_boundary.yaml",
  "release/decisions/post-rc/post_rc_production_monitoring_final_decision_record.yaml",
  "release/claims/post-rc/post_rc_production_monitoring_final_claim_boundary.yaml",
  "release/blockers/post-rc/post_rc_production_monitoring_final_blocker_update.yaml",
  "tools/runners/observability/run_post_rc_production_monitoring_final_gate.mjs",
  "tools/checks/observability/check_post_rc_production_monitoring_final_gate.mjs",
  "tools/audits/observability/audit_post_rc_production_monitoring_final_gate_claims.mjs",
  "tools/audits/release/audit_post_rc_production_monitored_claims.mjs",
  "tools/summaries/observability/summarize_post_rc_production_monitoring_final_evidence.mjs",
  ...
  "docs/observability/production_monitoring_final_gate.md",
  "docs/claims/production_monitored_claim_boundary.md",
  "docs/observability/production_monitoring_final_decision_record.md",
  "docs/plans/next_production_ready_scope_plan.md",
  "docs/plans/next_stable_scope_decision_plan.md",
  "docs/plans/next_local_canary_after_endpoint_ready.md",
  "docs/plans/next_production_ready_readiness_plan.md"
];
...
const refreshGate = readJsonIfExists("evidence/post-rc-reference-baseline-refresh-for-monitoring-result-review/post_rc_reference_baseline_refresh_gate_report.json");
...
addCheck(checks, "reference baseline refresh gate report pass",
  refreshGate?.status === "pass"
    && refreshGate?.check_reference_baseline_integrity_status === "pass"
...
addCheck(checks, "final evidence summary passed",
  evidenceSummary?.status === "pass"
    ...
    && evidenceSummary?.reference_baseline_owner_approved_refresh_effective === true
...
addCheck(checks, "evidence/reference-baseline only has prior owner-approved refresh changes",
  baselineStatus.exit_code === 0 && (
    baselineStatus.stdout === ""
    || report?.evidence_reference_baseline_modified_by_prior_owner_approved_refresh === true
  ), baselineStatus);
