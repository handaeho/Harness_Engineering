...
const REQUIRED_REL_PATHS = [
  "release/gates/post-combined/post_combined_provider_diverse_final_gate_scope.yaml",
  "release/gates/post-combined/post_combined_provider_diverse_final_gate.yaml",
  "release/claims/post-combined/post_combined_provider_diverse_claim_boundary.yaml",
  "release/blockers/post-combined/post_combined_provider_diverse_blocker_update.yaml",
  "release/decisions/post-combined/post_combined_provider_diverse_owner_final_decision.yaml",
  "release/decisions/post-combined/post_combined_provider_diverse_final_decision_record.yaml",
  "release/claims/post-combined/post_combined_provider_diverse_final_claim_boundary.yaml",
  "release/blockers/post-combined/post_combined_provider_diverse_final_blocker_update.yaml",
  ...
  "docs/providers/provider_diverse_final_gate.ko.md",
  "docs/claims/provider_diverse_final_claim_boundary.ko.md",
  "docs/providers/provider_diverse_final_decision_record.ko.md",
  "docs/plans/next_final_export_execution_plan.ko.md",
  "tools/runners/providers/run_provider_diverse_final_gate.mjs",
  "tools/checks/providers/check_provider_diverse_final_gate.mjs",
  "tools/audits/providers/audit_provider_diverse_final_claims.mjs",
  "tools/summaries/providers/summarize_provider_diverse_final_evidence.mjs"
];
