...
const REQUIRED_REL_PATHS = [
  ...
  "release/drafts/post-combined/post_combined_provider_diverse_final_export_draft_refresh.yaml",
  ...
  "tools/refresh/providers/refresh_combined_archive_after_provider_diverse.mjs",
  "tools/refresh/workspace/refresh_final_export_draft_after_provider_diverse.mjs",
  "tools/checks/providers/check_provider_diverse_archive_refresh.mjs"
];
