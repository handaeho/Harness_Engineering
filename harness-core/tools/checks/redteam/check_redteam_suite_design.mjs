...
const gate = exists("release/gates/redteam/redteam_execution_gate.yaml")
...
for (const relPath of [
  ...
  "release/gates/redteam/redteam_execution_gate.yaml",
  "release/blockers/redteam/redteam_blocker_update.yaml",
