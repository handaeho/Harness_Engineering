...
const broaderGate = runJsonTool("tools/checks/redteam/check_broader_redteam_pass_gate_design.mjs");
const dispositionAudit = runJsonTool("tools/audits/redteam/audit_skipped_redteam_case_dispositions.mjs");
