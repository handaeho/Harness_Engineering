...
for (const script of [
  "validators/evals/validate_alpha.mjs",
  "scanners/release/scan_prohibited_claims.mjs",
  "checks/workspace/check_reference_baseline_integrity.mjs",
  "validators/general/validate_agents_md_alignment.mjs"
]) {
...
const requiredFiles = [
  ...
  "release/scopes/rc1/rc1_agents_md_alignment_scope.yaml",
  "release/gates/general/system_of_record_alignment_gate.yaml",
...
try {
  ...
  const aligned = stack.agent_entrypoint?.path === "AGENTS.md"
    ...
    && includesPath(source.release_contract, "release/claims/general/claim_ladder.md")
    && includesPath(source.release_contract, "release/gates/core-release/release_gate.yaml")
