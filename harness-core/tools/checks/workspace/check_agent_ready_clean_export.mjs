...
const result = spawnSync(process.execPath, ["tools/checks/workspace/check_clean_export_self_contained.mjs"], {
  cwd: root,
  encoding: "utf8",
...
const report = {
  ...
  delegated_checker: "tools/checks/workspace/check_clean_export_self_contained.mjs",
