...
for (const relPath of [
  "release/scopes/beta/beta_execution_readiness_dashboard_scope.yaml",
  "release/gates/general/execution_readiness_gate.yaml",
  "release/decisions/general/next_execution_decision_matrix.yaml",
  "release/blockers/general/blocked_execution_lanes.yaml",
  "release/approvals/general/approval_phrase_index.yaml",
  "release/requirements/general/environment_requirement_index.yaml",
  "release/commands/general/command_plan_index.yaml",
  "release/claims/general/claim_impact_matrix.yaml",
