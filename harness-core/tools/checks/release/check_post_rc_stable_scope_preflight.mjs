...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_stable_scope_preflight_scope.yaml",
  "release/scopes/post-rc/post_rc_stable_scope_decision_matrix.yaml",
  "release/blockers/post-rc/post_rc_stable_blocker_matrix.yaml",
  "release/decisions/post-rc/post_rc_stable_owner_decision_request.yaml",
  "release/claims/post-rc/post_rc_stable_claim_boundary.yaml",
  "release/claims/post-rc/post_rc_production_ready_claim_canonicalization.yaml",
  "tools/assessments/release/assess_post_rc_stable_scope_preflight.mjs",
  "tools/audits/release/audit_post_rc_stable_claim_boundary.mjs",
  "tools/checks/release/check_post_rc_stable_scope_preflight.mjs",
  ...
  "docs/release/stable_scope_preflight.md",
  "docs/release/stable_blocker_matrix.md",
  "docs/release/stable_scope_decision_matrix.md",
  "docs/approvals/stable_owner_decision_request.md",
  "docs/claims/production_ready_claim_canonicalization.md",
  "docs/plans/next_openai_only_stable_scope_decision_plan.md",
...
addCheck(checks, "evidence/reference-baseline has no this-stage modification beyond prior owner-approved refresh files",
