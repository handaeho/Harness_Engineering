...
import { runAudit, resolveRoot, STAGE } from "../../runners/security/run_cross_suite_storage_redaction_audit.mjs";
...
const classifyTool = runJsonTool("tools/classifiers/security/classify_storage_redaction_findings.mjs", true);
const summaryTool = runJsonTool("tools/summaries/security/summarize_storage_redaction_audit.mjs", true);
...
const containmentGate = runJsonTool("tools/checks/security/check_containment_verification_gate_refinement.mjs");
