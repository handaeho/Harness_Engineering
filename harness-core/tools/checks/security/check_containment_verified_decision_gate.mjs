...
import { buildContainmentVerifiedDecisionGateArtifacts, resolveRoot, STAGE } from "../../runners/security/run_containment_verified_decision_gate.mjs";
...
for (const relPath of [
  "release/gates/beta/beta_containment_verified_decision_gate_scope.yaml",
  "release/gates/containment/containment_verified_decision_gate.yaml",
  "release/decisions/containment/containment_owner_final_decision.yaml",
  "release/blockers/containment/containment_verified_blocker_update.yaml",
  ...
  "tools/runners/security/run_containment_verified_decision_gate.mjs",
  "tools/audits/security/audit_containment_verified_evidence_sufficiency.mjs",
  "tools/audits/security/audit_containment_verified_claim_boundary.mjs",
  "tools/checks/security/check_containment_verified_decision_gate.mjs",
