...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_openai_only_production_ready_scope_decision_scope.yaml",
  "release/gates/post-rc/post_rc_openai_only_production_ready_gate.yaml",
  "release/claims/post-rc/post_rc_openai_only_production_ready_claim_boundary.yaml",
  "release/decisions/post-rc/post_rc_openai_only_production_ready_decision_record.yaml",
  "release/blockers/post-rc/post_rc_openai_only_production_ready_blocker_update.yaml",
  "release/scopes/post-rc/post_rc_openai_only_production_ready_out_of_scope_boundaries.yaml",
  "tools/runners/openai/run_post_rc_openai_only_production_ready_scope_decision.mjs",
  "tools/audits/openai/audit_post_rc_openai_only_production_ready_claims.mjs",
  "tools/checks/openai/check_post_rc_openai_only_production_ready_scope_decision.mjs",
  ...
  "docs/local/openai_only_production_ready_scope_decision.md",
  "docs/claims/production_ready_openai_only_claim_boundary.md",
  "docs/release/production_ready_out_of_scope_boundaries.md",
