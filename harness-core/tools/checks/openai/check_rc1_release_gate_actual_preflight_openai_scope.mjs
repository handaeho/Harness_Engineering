...
import {
  ...
  resolveRoot
} from "../../runners/openai/run_rc1_release_gate_actual_preflight_openai_scope.mjs";
...
for (const relPath of [
  "release/gates/rc1/rc1_release_gate_actual_openai_scope_preflight_scope.yaml",
  "release/gates/rc1/rc1_release_gate_actual_approval_gate.yaml",
  "release/approvals/rc1/rc1_release_gate_actual_approval_request.md",
  "release/commands/rc1/rc1_release_gate_actual_command_plan.yaml",
  "release/gates/rc1/rc1_release_gate_actual_preflight_policy.yaml",
  "release/decisions/rc1/rc1_release_decision_record_preflight.yaml",
  "release/readiness/rc1/rc1_rollback_readiness.yaml",
  "release/readiness/rc1/rc1_owner_action_readiness.yaml",
  "release/records/rc1/rc1_local_endpoint_deferred_confirmation.yaml",
  "release/records/rc1/rc1_provider_diversity_deferred_confirmation.yaml",
  "tools/runners/openai/run_rc1_release_gate_actual_preflight_openai_scope.mjs",
  "tools/audits/release/audit_rc1_actual_gate_readiness.mjs",
  "tools/audits/release/audit_rc1_rollback_owner_readiness.mjs",
  "tools/checks/openai/check_rc1_release_gate_actual_preflight_openai_scope.mjs",
  ...
  "docs/local/rc1_release_gate_actual_openai_scope_preflight.md",
  "docs/approvals/rc1_release_gate_actual_approval_request.md",
  "docs/approvals/rc1_release_gate_actual_command_plan.md",
  "docs/release/rc1_rollback_readiness.md",
  "docs/approvals/rc1_owner_action_readiness.md",
  "docs/plans/next_rc1_release_gate_actual_execution.md",
...
addCheck("actual execution stage scripts were not created", !exists("tools/runners/openai/run_rc1_release_gate_actual_openai_scope.mjs")
  && !exists("tools/checks/openai/check_rc1_release_gate_actual_openai_scope.mjs"), {
  run_actual_exists: exists("tools/runners/openai/run_rc1_release_gate_actual_openai_scope.mjs"),
  check_actual_exists: exists("tools/checks/openai/check_rc1_release_gate_actual_openai_scope.mjs")
});
