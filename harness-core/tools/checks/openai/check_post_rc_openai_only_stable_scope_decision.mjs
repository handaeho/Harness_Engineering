...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_openai_only_stable_scope_decision_scope.yaml",
  "release/gates/post-rc/post_rc_openai_only_stable_gate.yaml",
  "release/claims/post-rc/post_rc_openai_only_stable_claim_boundary.yaml",
  "release/decisions/post-rc/post_rc_openai_only_stable_decision_record.yaml",
  "release/blockers/post-rc/post_rc_openai_only_stable_blocker_update.yaml",
  "release/scopes/post-rc/post_rc_openai_only_stable_out_of_scope_boundaries.yaml",
  "release/scopes/post-rc/post_rc_stable_local_provider_out_of_scope_record.yaml",
  "tools/evaluations/openai/evaluate_post_rc_openai_only_stable_scope.mjs",
  "tools/runners/openai/run_post_rc_openai_only_stable_scope_decision.mjs",
  "tools/audits/openai/audit_post_rc_openai_only_stable_claims.mjs",
  "tools/checks/openai/check_post_rc_openai_only_stable_scope_decision.mjs",
  ...
  "docs/local/openai_only_stable_scope_decision.md",
  "docs/claims/openai_only_stable_claim_boundary.md",
  "docs/claims/stable_openai_only_claim_boundary.md",
  "docs/release/stable_out_of_scope_boundaries.md",
  "docs/providers/stable_local_provider_out_of_scope.md",
  "docs/plans/next_post_stable_options.md",
  "docs/plans/next_local_canary_after_endpoint_ready.md",
  "docs/plans/next_provider_diverse_stable_path_plan.md"
];
