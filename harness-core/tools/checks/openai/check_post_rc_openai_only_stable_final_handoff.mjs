...
const REQUIRED_FILES = [
  "release/scopes/post-rc/post_rc_openai_only_stable_final_handoff_scope.yaml",
  "release/claims/post-rc/post_rc_openai_only_stable_final_claim_state.yaml",
  "release/manifests/post-rc/post_rc_openai_only_stable_archive_manifest.yaml",
  "release/paths/post-rc/post_rc_openai_only_stable_deferred_paths.yaml",
  "release/decisions/post-rc/post_rc_openai_only_stable_next_options.yaml",
  "tools/builders/openai/build_post_rc_openai_only_stable_final_handoff.mjs",
  "tools/generators/openai/generate_post_rc_openai_only_stable_archive_manifest.mjs",
  "tools/checks/openai/check_post_rc_openai_only_stable_final_handoff.mjs",
  ...
  "docs/handoffs/openai_only_stable_final_handoff.md",
  "docs/claims/openai_only_stable_final_claim_state.md",
  "docs/local/openai_only_stable_archive_manifest.md",
  "docs/local/openai_only_stable_deferred_paths.md",
  "docs/plans/next_options_after_openai_only_stable.md",
...
const finalReferenceBaselineRefreshStatus = readJsonIfExists(`${EVIDENCE_DIR}/final_reference_baseline_refresh_status.json`);
...
const baselineRefreshFiles = finalReferenceBaselineRefreshStatus?.owner_approved_refresh_files_still_modified_in_worktree || [];
addCheck(checks, "reference baseline refresh status records prior owner-approved files only",
  finalReferenceBaselineRefreshStatus?.status === "recorded"
    && finalReferenceBaselineRefreshStatus?.check_reference_baseline_integrity_status === "pass"
    && finalReferenceBaselineRefreshStatus?.reference_baseline_source_modified === false
    && finalReferenceBaselineRefreshStatus?.dist_modified === false
    && finalReferenceBaselineRefreshStatus?.additional_refresh_in_this_stage === false
    && includesAll(baselineRefreshFiles, PRIOR_BASELINE_REFRESH_FILES),
  finalReferenceBaselineRefreshStatus || {});
