...
const skippedGate = runJsonTool("tools/checks/redteam/check_skipped_redteam_case_review.mjs");
const validatePreflight = runJsonTool("tools/validators/openai/validate_additional_openai_redteam_preflight.mjs");
