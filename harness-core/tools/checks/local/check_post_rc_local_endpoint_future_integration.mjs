...
addCheck(checks, "local endpoint deferred policy is Korean-documented",
  docTexts["docs/local/local_endpoint_future_integration.ko.md"].includes("현재 local endpoint는 준비되지 않았다")
    && docTexts["docs/local/local_endpoint_future_integration.ko.md"].includes("현재 goal에서 수행하지 않는다")
    && docTexts["docs/approvals/local_endpoint_operator_handoff_template.ko.md"].includes("operator 준비 완료 신호 전에는 local endpoint probe를 수행하지 않는다"),
  {});
