...
addCheck(checks, "release/gates/local/local_model_verification_gate.yaml exists", fs.existsSync(p("release", "local_model_verification_gate.yaml")), {});
addCheck(checks, "docs/local/local_model_verification_execution_plan.md exists", fs.existsSync(p("docs", "local_model_verification_execution_plan.md")), {});
