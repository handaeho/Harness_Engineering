...
const REQUIRED_REL_PATHS = [
  "release/gates/post-stable/post_stable_local_model_verification_final_gate_scope.yaml",
  "release/gates/post-stable/post_stable_local_model_verification_final_gate.yaml",
  "release/decisions/post-stable/post_stable_local_model_verification_owner_final_decision.yaml",
  "release/decisions/post-stable/post_stable_local_model_verification_final_decision_record.yaml",
  "release/claims/post-stable/post_stable_local_model_verified_claim_boundary.yaml",
  "release/blockers/post-stable/post_stable_local_model_verification_final_blocker_update.yaml",
  "release/blockers/post-stable/post_stable_local_model_verification_blocker_update.yaml",
  ...
  "docs/local/local_model_verification_final_gate.ko.md",
  "docs/claims/local_model_verified_claim_boundary.ko.md",
  "docs/local/local_model_verification_final_decision_record.ko.md",
  "docs/plans/next_provider_diverse_path_plan.ko.md",
  "docs/plans/next_adapter_checked_path_plan.ko.md",
  "tools/runners/local/run_local_model_verification_final_gate.mjs",
  "tools/checks/local/check_local_model_verification_final_gate.mjs",
  "tools/audits/local/audit_local_model_verified_claims.mjs",
  "tools/summaries/local/summarize_local_model_verification_final_evidence.mjs"
];
