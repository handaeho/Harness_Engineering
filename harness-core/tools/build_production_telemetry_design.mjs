...
writeYaml("release/beta_production_telemetry_design_scope.yaml", {
  stage: STAGE,
  approved_actions: {
...
writeYaml("release/production_telemetry_gate.yaml", {
...
writeYaml("release/telemetry_blocker_update.yaml", blockerUpdate);
...
const report = {
  ...
  production_telemetry_gate_exists: exists("release/production_telemetry_gate.yaml"),
  can_claim_telemetry_connected: false,
  can_claim_production_monitored: false,
  can_claim_production_ready: false,
  claims_allowed: claimsAllowed,
...
const docs = {
  "docs/production_telemetry_design.md": `# Production Telemetry Design
...
`,
  "docs/otel_genai_mapping.md": `# OTel GenAI Mapping
...
`,
  "docs/langfuse_integration_plan.md": `# Langfuse Integration Plan
...
`,
  "docs/telemetry_dashboard_spec.md": `# Telemetry Dashboard Spec
...
`,
  "docs/telemetry_claim_gate.md": `# Telemetry Claim Gate
