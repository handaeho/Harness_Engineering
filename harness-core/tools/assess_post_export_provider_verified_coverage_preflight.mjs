...
writeYamlRel("release/post_export_provider_verified_coverage_preflight_scope.yaml", [
  `stage: ${STAGE}`,
  "status: blocked_by_missing_provider_coverage",
  `scope: ${SCOPE}`,
  `archive_label: ${ARCHIVE_LABEL}`,
...
writeYamlRel("release/post_export_provider_verified_coverage_matrix.yaml", [
  `stage: ${STAGE}`,
  "status: recorded",
  "provider_verified_allowed: false",
  "can_enter_provider_verified_final_gate: false",
...
writeYamlRel("release/post_export_provider_verified_claim_boundary.yaml", [
  `stage: ${STAGE}`,
  "status: pass",
  "provider_diverse_allowed: true",
  "local_model_verified_allowed: true",
...
writeYamlRel("release/post_export_provider_verified_blocker_update.yaml", [
  `stage: ${STAGE}`,
  "status: blocked_by_missing_provider_coverage",
  "provider_verified_allowed: false",
  "can_enter_provider_verified_final_gate: false",
...
writeMarkdownReport("docs/provider_verified_coverage_preflight.ko.md", "Provider-Verified Coverage Preflight", [
...
writeMarkdownReport("docs/provider_verified_coverage_matrix.ko.md", "Provider-Verified Coverage Matrix", [
...
writeMarkdownReport("docs/provider_verified_missing_coverage.ko.md", "Provider-Verified Missing Coverage", [
  "Provider-verified를 열기 전 필요한 blocker입니다.",
  "",
  ...missingOrPartialCoverage.map((item) => `- ${item.id}: ${item.recommended_next_action}`)
]);
writeMarkdownReport("docs/next_provider_verified_final_gate_plan.ko.md", "Next Provider-Verified Final Gate Plan", [
...
writeMarkdownReport("docs/next_adapter_checked_coverage_plan.ko.md", "Next Adapter-Checked Coverage Plan", [
