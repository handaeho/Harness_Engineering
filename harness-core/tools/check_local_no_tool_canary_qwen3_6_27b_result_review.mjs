...
const REQUIRED = [
  "local_no_tool_canary_qwen3_6_27b_result_review.json",
  "local_endpoint_readiness_evidence_index.json",
  "local_no_tool_canary_evidence_index.json",
  "qwen3_6_27b_reasoning_control_record.json",
  "local_no_tool_storage_redaction_review.json",
  "local_no_tool_canary_qwen3_6_27b_claim_boundary.json",
  "local_no_tool_canary_qwen3_6_27b_blocker_update.json",
  "multimodel_comparison_preconditions.json",
  "local_no_tool_canary_qwen3_6_27b_gate_report.json",
...
const result = fs.existsSync(e("local_no_tool_canary_qwen3_6_27b_result_review.json"))
  ? readJson(e("local_no_tool_canary_qwen3_6_27b_result_review.json"))
  : null;
const boundary = fs.existsSync(e("local_no_tool_canary_qwen3_6_27b_claim_boundary.json"))
  ? readJson(e("local_no_tool_canary_qwen3_6_27b_claim_boundary.json"))
  : null;
const storage = fs.existsSync(e("local_no_tool_storage_redaction_review.json"))
  ...
  : null;
const reasoning = fs.existsSync(e("qwen3_6_27b_reasoning_control_record.json"))
  ? readJson(e("qwen3_6_27b_reasoning_control_record.json"))
  : null;
const preconditions = fs.existsSync(e("multimodel_comparison_preconditions.json"))
  ? readJson(e("multimodel_comparison_preconditions.json"))
  : null;
...
addCheck(checks, "think_false_applied == true", result?.think_false_applied === true && reasoning?.think_false_applied === true, {});
addCheck(checks, "reasoning_effort_none_applied == true", result?.reasoning_effort_none_applied === true
  && reasoning?.reasoning_effort_none_applied === true, {});
addCheck(checks, "reasoning_effort_nested_none_applied == true", result?.reasoning_effort_nested_none_applied === true
  && reasoning?.reasoning_effort_nested_none_applied === true, {});
...
addCheck(checks, "release_gated_allowed == false", boundary?.release_gated_allowed === false, {});
...
addCheck(checks, "evidence_reference_baseline_modified == false", result?.evidence_reference_baseline_modified === false, {});
addCheck(checks, "multimodel comparison preconditions ready", preconditions?.status === "ready"
  && preconditions?.qwen3_14b_result_review_passed === true
  && preconditions?.qwen3_6_27b_result_review_passed === true, preconditions || {});
...
const md = `# qwen3.6:27b Local No-tool Result Review Gate
...
writeJson(p("evals", "reports", "local_no_tool_canary_qwen3_6_27b_gate_report.json"), report);
