...
\`\`\`powershell
node harness-core/tools/checks/security/check_containment_verified_decision_gate.mjs
\`\`\`
`;
}
...
- Gate script: \`harness-core/tools/checks/security/check_containment_verified_decision_gate.mjs\`
...
function writeAll(root, artifacts) {
  ...
  writeText(p(root, "release", "gates", "core-release", "release_gate.yaml"), releaseGateYaml(decision));
