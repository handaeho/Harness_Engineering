...
\`\`\`powershell
node tools/checks/openai/check_rc1_release_gate_dry_run_openai_scope.mjs
\`\`\`
`;
}
...
- Gate script: \`harness-core/tools/checks/openai/check_rc1_release_gate_dry_run_openai_scope.mjs\`
