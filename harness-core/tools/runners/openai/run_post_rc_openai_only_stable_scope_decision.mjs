...
const evidenceInventory = {
  ...
  reference_baseline_compare_pass: evidenceSummary.check_reference_baseline_integrity_status === "pass",
...
const gateCriteria = {
  ...
  required_criteria: {
    ...
    reference_baseline_compare_pass: evidenceInventory.reference_baseline_compare_pass,
