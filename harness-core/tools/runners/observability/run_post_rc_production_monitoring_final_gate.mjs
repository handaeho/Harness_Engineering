...
`);
  writeDocText("docs/observability/production_monitoring_final_gate.md", `# Production Monitoring Final Gate
...
`);
  writeDocText("docs/claims/production_monitored_claim_boundary.md", `# Production-Monitored Claim Boundary
...
`);
  writeDocText("docs/plans/next_production_ready_readiness_plan.md", `# Next Production Ready Readiness Plan
...
`);
  writeDocText("docs/observability/production_monitoring_final_decision_record.md", `# Production Monitoring Final Decision Record
...
`);
  writeDocText("docs/plans/next_production_ready_scope_plan.md", `# Next Production Ready Scope Plan
...
`);
  writeDocText("docs/plans/next_stable_scope_decision_plan.md", `# Next Stable Scope Decision Plan
...
`);
  writeDocText("docs/plans/next_local_canary_after_endpoint_ready.md", `# Next Local Canary After Endpoint Ready
