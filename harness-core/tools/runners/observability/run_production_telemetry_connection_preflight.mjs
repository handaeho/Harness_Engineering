...
function writeStaticArtifacts() {
  writeYaml("release/scopes/beta/beta_production_telemetry_connection_preflight_scope.yaml", {
    stage: STAGE,
    approved_actions: {
  ...
  writeYaml("release/gates/telemetry/production_telemetry_connection_approval_gate.yaml", {
    approval_gate: {
      stage: STAGE,
...
`);
  ...
  writeYaml("release/commands/telemetry/production_telemetry_connection_command_plan.yaml", {
    command_plan: {
      ...
      commands: [
        "node harness-core/tools/run_production_telemetry_connection.mjs",
        "node harness-core/tools/check_production_telemetry_connection.mjs"
      ],
  ...
  writeYaml("release/blockers/telemetry/telemetry_connection_blocker_update.yaml", blockerUpdate);
  ...
  writeYaml("observability/telemetry_connection_preflight_policy.yaml", {
    preflight_policy: {
      ...
      required_artifacts: [
        ...
        "release/gates/telemetry/production_telemetry_connection_approval_gate.yaml"
      ],
  ...
  writeYaml("evals/suites/beta_production_telemetry_connection_preflight.yaml", {
    ...
    required_artifacts: [
      "release/gates/telemetry/production_telemetry_connection_approval_gate.yaml",
      "release/approvals/telemetry/production_telemetry_connection_approval_request.md",
      "release/commands/telemetry/production_telemetry_connection_command_plan.yaml",
      "observability/otel/otlp_payload_shape.schema.json",
      "observability/langfuse/langfuse_payload_shape.schema.json",
...
function writeDocs(status) {
  const docs = {
    "docs/observability/production_telemetry_connection_preflight.md": `# Production Telemetry Connection Preflight
...
`,
    "docs/approvals/production_telemetry_connection_approval_request.md": readText(p("release", "production_telemetry_connection_approval_request.md")),
    "docs/approvals/telemetry_connection_commands.md": `# Telemetry Connection Commands
...
${REQUIRED_APPROVAL_PHRASE}
`,
    "docs/observability/telemetry_payload_shape_validation.md": `# Telemetry Payload Shape Validation
...
`,
    "docs/plans/next_telemetry_connection_after_approval.md": `# Next Telemetry Connection After Approval
...
const report = {
  ...
  approval_packet_generated: true,
  command_plan_generated: exists("release/commands/telemetry/production_telemetry_connection_command_plan.yaml"),
