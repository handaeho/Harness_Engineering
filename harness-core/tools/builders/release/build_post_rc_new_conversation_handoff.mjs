...
const finalReferenceBaselineRefreshStatus = readJsonIfExists("evidence/post-rc-openai-only-stable-final-handoff/final_reference_baseline_refresh_status.json") || {};
...
const evidencePointerEntries = [
  ...
  },
  {
    ...
    path: "docs/plans/next_rc1_post_release_gate_review.md",
    supports_claims: ["rc1-openai-scope-release-gated"],
  ...
  {
    group_id: "reference-baseline-owner-approved-refresh",
...
const promptMarkdown = `이 대화는 기존 harness-core 작업을 이어받는 새 대화입니다.
...
- reference baseline source modified: ${handoffReport.reference_baseline_source_modified}
- dist modified: ${handoffReport.dist_modified}
- Additional reference baseline refresh: ${handoffReport.additional_reference_baseline_refresh}
`;
...
checks:
  ...
  - check_reference_baseline_integrity
...
const result = {
  ...
  generated_files: [
    ...
    "release/scopes/post-rc/post_rc_new_conversation_handoff_scope.yaml",
    "release/claims/post-rc/post_rc_new_conversation_handoff_claim_state.yaml",
    "release/decisions/post-rc/post_rc_new_conversation_next_options.yaml",
    ...
    "docs/handoffs/new_conversation_handoff.md",
    "docs/handoffs/new_conversation_prompt.md",
    "docs/handoffs/new_conversation_next_options.md"
  ],
  owner_approved_baseline_refresh_files_recorded: ownerApprovedBaselineRefreshFiles,
  final_handoff_gate_status: finalHandoffGate.status || "not_read",
  final_reference_baseline_refresh_status: finalReferenceBaselineRefreshStatus.status || "not_read",
