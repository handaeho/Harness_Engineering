...
function writeSuites() {
  ...
  writeYaml("evals/suites/redteam_suite_design.yaml", {
    ...
    execution_gate: "release/gates/redteam/redteam_execution_gate.yaml"
  });
}
...
`);
  ...
  const docs = {
    "docs/security/redteam_suite_design.md": `# Redteam Suite Design

Stage: ${STAGE}

This design adds a redteam taxonomy, fixture set, severity rubric, OWASP/NIST/MITRE mappings, and a closed execution gate for harness-core.
...
`,
    "docs/security/redteam_fixture_authoring.md": `# Redteam Fixture Authoring
...
`,
    "docs/security/redteam_severity_rubric.md": `# Redteam Severity Rubric
...
`,
    "docs/security/redteam_execution_gate.md": `# Redteam Execution Gate
...
`,
    "docs/plans/next_redteam_execution_plan.md": `# Next Redteam Execution Plan
...
`,
    "docs/plans/next_production_telemetry_plan.md": `# Next Production Telemetry Plan
...
writeYaml("release/scopes/beta/beta_redteam_suite_design_scope.yaml", scope);
writeYaml("release/gates/redteam/redteam_execution_gate.yaml", executionGate);
writeYaml("release/blockers/redteam/redteam_blocker_update.yaml", blockerUpdate);
