...
function writeReleaseArtifacts() {
  writeRelText("release/scopes/post-rc/post_rc_production_monitoring_values_owner_preflight_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/gates/post-rc/post_rc_production_monitoring_values_owner_gate.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/preconditions/post-rc/post_rc_production_monitoring_window_preconditions.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/approvals/post-rc/post_rc_production_monitoring_values_approval_request.md", `# Post-RC Production Monitoring Values Approval Request
...
`);
  ...
  writeRelText("release/commands/post-rc/post_rc_production_monitoring_window_command_plan.yaml", `command_plan:
  ...
  commands:
    - node harness-core/tools/runners/observability/run_post_rc_production_monitoring_window.mjs
    - node harness-core/tools/checks/observability/check_post_rc_production_monitoring_window.mjs
...
forbidden_execution:
  ...
  local_model_execution: true
gate:
  script: tools/checks/observability/check_post_rc_production_monitoring_values_preflight.mjs
...
`);
  ...
  copyToSnapshot("release/commands/post-rc/post_rc_production_monitoring_window_command_plan.yaml", SNAPSHOT_FILES.commandPlan);
}

function writeDocs() {
  writeRelText("docs/approvals/production_monitoring_values_owner_preflight.md", `# Production Monitoring Values Owner and Window Preflight
...
`);
  ...
  writeRelText("docs/approvals/production_monitoring_operator_values_template.md", `# Production Monitoring Operator Values Template
...
`);
  ...
  writeRelText("docs/observability/production_monitoring_recommended_defaults.md", `# Production Monitoring Recommended Defaults
...
`);
  ...
  writeRelText("docs/observability/production_monitoring_window_execution_plan.md", `# Production Monitoring Window Execution Plan
...
`);
  ...
  writeRelText("docs/approvals/production_monitoring_values_approval_request.md", `# Production Monitoring Values Approval Request
