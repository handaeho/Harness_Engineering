...
function writeStaticArtifacts() {
  writeRelText("release/gates/post-rc/post_rc_production_monitoring_readiness_gate.yaml", `stage: ${READINESS_STAGE}
...
`);
  ...
  writeRelText("release/blockers/post-rc/post_rc_production_monitoring_blocker_update.yaml", `stage: ${READINESS_STAGE}
status: blocked_not_production_monitored
resolved:
...
gate:
  script: tools/checks/observability/check_post_rc_production_monitoring_readiness.mjs
required_artifacts:
...
`);
  ...
  writeRelTextIfMissing("docs/observability/production_monitoring_readiness.md", `# Production Monitoring Readiness
...
`);
  ...
  writeRelTextIfMissing("docs/observability/production_monitoring_remaining_controls.md", `# Production Monitoring Remaining Controls
...
`);
  ...
  writeRelTextIfMissing("docs/plans/next_production_monitoring_gate_plan.md", `# Next Production Monitoring Gate Plan
...
`);
  ...
  writeRelTextIfMissing("docs/plans/next_local_canary_after_endpoint_ready.md", `# Next Local Canary After Endpoint Ready
