...
writeTextRel("release/scopes/post-combined/post_combined_provider_diverse_archive_refresh_scope.yaml", `stage: ${STAGE}
status: recorded
approved_actions:
...
writeTextRel("release/claims/post-combined/post_combined_provider_diverse_final_claim_state.yaml", `stage: ${STAGE}
status: recorded
archive_scope: ${SCOPE}
archive_label: ${ARCHIVE_LABEL}
provider_diverse: true
...
writeTextRel("release/manifests/post-combined/post_combined_provider_diverse_archive_manifest.yaml", `stage: ${STAGE}
status: recorded
archive_label: ${ARCHIVE_LABEL}
scope: ${SCOPE}
provider_diverse: true
...
writeTextRel("release/gates/post-combined/post_combined_provider_diverse_next_gates.yaml", `stage: ${STAGE}
status: recorded
next_gates:
  - id: NEXT-001
    name: provider_verified_gate_preflight
...
writeKoDoc("docs/providers/provider_diverse_archive_refresh.ko.md", "Provider-Diverse Archive Refresh", [
...
writeKoDoc("docs/claims/provider_diverse_final_claim_state.ko.md", "Provider-Diverse Final Claim State", [
  "Allowed:",
...
writeKoDoc("docs/providers/provider_diverse_next_gates.ko.md", "Provider-Diverse Next Gates", [
...
writeKoDoc("docs/plans/next_provider_verified_gate_preflight_plan.ko.md", "Next Provider-Verified Gate Preflight Plan", [
...
writeKoDoc("docs/plans/next_adapter_checked_gate_preflight_plan.ko.md", "Next Adapter-Checked Gate Preflight Plan", [
...
const checksumTargets = [
  ...
  "release/scopes/post-combined/post_combined_provider_diverse_archive_refresh_scope.yaml",
  "release/claims/post-combined/post_combined_provider_diverse_final_claim_state.yaml",
  "release/manifests/post-combined/post_combined_provider_diverse_archive_manifest.yaml",
  "release/gates/post-combined/post_combined_provider_diverse_next_gates.yaml",
  ...
  "docs/providers/provider_diverse_archive_refresh.ko.md",
  "docs/claims/provider_diverse_final_claim_state.ko.md",
  "docs/providers/provider_diverse_next_gates.ko.md",
  "docs/plans/next_provider_verified_gate_preflight_plan.ko.md",
  "docs/plans/next_adapter_checked_gate_preflight_plan.ko.md",
  "docs/plans/next_final_export_execution_plan.ko.md"
];
