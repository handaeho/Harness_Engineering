...
writeTextRel("release/post_combined_provider_diverse_final_gate_scope.yaml", `stage: ${STAGE}\nstatus: ${report.status}\nscope: ${SCOPE}\nprovider_diverse_allowed: ${report.provider_diverse_allowed}\nprovider_verified_allowed: false\nadapter_checked_allowed: false\nproduction_ready_allowed: false\nstable_allowed: false\nrelease_gated_allowed: false\nnew_execution: false\n`);
writeTextRel("release/post_combined_provider_diverse_final_gate.yaml", `stage: ${STAGE}\nstatus: ${report.status}\ncan_claim_provider_diverse: ${report.can_claim_provider_diverse}\nsource_lanes:\n  - openai_api_lane\n  - ollama_qwen3_local_lane\n`);
writeTextRel("release/post_combined_provider_diverse_owner_final_decision.yaml", `stage: ${STAGE}\nstatus: ${ownerDecision.status}\ndecision: ${ownerDecision.decision}\napproved_claim: ${ownerDecision.approved_claim || "null"}\n`);
writeTextRel("release/post_combined_provider_diverse_final_decision_record.yaml", `stage: ${STAGE}\nstatus: ${finalDecision.status}\ndecision: ${finalDecision.decision}\nprovider_diverse_allowed: ${finalDecision.provider_diverse_allowed}\nprovider_verified_allowed: false\nadapter_checked_allowed: false\nproduction_ready_allowed: false\nstable_allowed: false\nrelease_gated_allowed: false\n`);
writeTextRel("release/post_combined_provider_diverse_final_claim_boundary.yaml", `stage: ${STAGE}\nstatus: ${boundary.status}\nprovider_diverse_allowed: ${boundary.provider_diverse_allowed}\nprovider_verified_allowed: false\nadapter_checked_allowed: false\nproduction_ready_allowed: false\nstable_allowed: false\nrelease_gated_allowed: false\n`);
writeTextRel("release/post_combined_provider_diverse_final_blocker_update.yaml", `stage: ${STAGE}\nstatus: ${blocker.status}\nprovider_diverse_allowed: ${blocker.provider_diverse_allowed}\nstill_blocked_claims:\n  - provider-verified\n  - adapter-checked\n  - production-ready\n  - stable\n  - release-gated\n`);
writeTextRel("release/post_combined_provider_diverse_claim_boundary.yaml", `stage: ${STAGE}\nstatus: ${boundary.status}\nprovider_diverse_allowed: ${boundary.provider_diverse_allowed}\nprovider_verified_allowed: false\nadapter_checked_allowed: false\nproduction_ready_allowed: false\nstable_allowed: false\nrelease_gated_allowed: false\nbare_release_gated_allowed: false\n`);
writeTextRel("release/post_combined_provider_diverse_blocker_update.yaml", `stage: ${STAGE}\nstatus: ${blocker.status}\nprevious_status: ${blocker.previous_status}\nnew_status: ${blocker.new_status}\nunblocks:\n  - provider-diverse\nstill_blocks:\n  - provider-verified\n  - adapter-checked\n  - production-ready\n  - stable\n  - bare release-gated\n`);
...
writeKoDoc("docs/provider_diverse_final_gate.ko.md", "Provider Diverse Final Gate", [
...
writeKoDoc("docs/provider_diverse_final_claim_boundary.ko.md", "Provider Diverse Final Claim Boundary", [
...
writeKoDoc("docs/provider_diverse_claim_boundary.ko.md", "Provider Diverse Claim Boundary", [
  "`provider-diverse` claim만 OpenAI API lane plus Ollama qwen3 local lane scope에서 허용합니다.",
  "`provider-verified`, `adapter-checked`, bare `production-ready`, bare `stable`, bare `release-gated`는 계속 차단합니다."
]);
writeKoDoc("docs/provider_diverse_final_decision_record.ko.md", "Provider Diverse Final Decision Record", [
  `Decision: \`${finalDecision.decision}\``,
  `Approved claim: \`${finalDecision.approved_claim || "null"}\``,
  `Scope: \`${SCOPE}\``
]);
writeKoDoc("docs/next_provider_verified_gate_plan.ko.md", "Next Provider Verification Gate Plan", [
...
writeKoDoc("docs/next_adapter_checked_gate_plan.ko.md", "Next Adapter Checked Gate Plan", [
