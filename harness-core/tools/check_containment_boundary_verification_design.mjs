...
const skippedReview = runJsonTool("tools/check_skipped_redteam_case_review.mjs");
const fixtureValidation = runJsonTool("tools/validate_containment_fixtures.mjs");
const coverageSummary = runJsonTool("tools/summarize_containment_coverage.mjs");
const claimAudit = runJsonTool("tools/audit_containment_claim_boundary.mjs");
...
for (const relPath of [
  ...
  "release/containment_blocker_update.yaml",
