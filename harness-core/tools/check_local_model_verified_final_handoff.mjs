...
const REQUIRED_FILES = [
  ...
  "tools/build_local_model_verified_final_handoff.mjs",
  "tools/generate_local_model_verified_archive_manifest.mjs",
  "tools/check_local_model_verified_final_handoff.mjs",
