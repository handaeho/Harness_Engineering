...
const boundary = readJson(p("evidence", EVIDENCE_DIR, "local_no_tool_canary_qwen3_14b_claim_boundary.json"));
...
const md = `# qwen3:14b Local No-tool Claim Audit
...
writeJson(p("evidence", EVIDENCE_DIR, "local_no_tool_canary_qwen3_14b_claim_audit.json"), report);
writeJson(p("evals", "reports", "local_no_tool_canary_qwen3_14b_claim_audit_report.json"), report);
writeText(p("evals", "reports", "local_no_tool_canary_qwen3_14b_claim_audit_report.md"), md);
