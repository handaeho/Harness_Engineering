...
const finalReference BaselineBaselineRefreshStatus = {
  status: "recorded",
  stage: STAGE,
...
writeJsonSafe(e("final_reference_baseline_refresh_status.json"), finalReference BaselineBaselineRefreshStatus);
