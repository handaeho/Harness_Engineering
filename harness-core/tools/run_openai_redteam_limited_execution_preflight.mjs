...
function writeStaticArtifacts() {
  writeYaml("release/beta_openai_redteam_limited_execution_preflight_scope.yaml", {
    stage: STAGE,
    approved_actions: {
  ...
  writeYaml("release/openai_redteam_limited_execution_approval_gate.yaml", approvalGate);
...
`;
  ...
  writeYaml("release/openai_redteam_limited_execution_command_plan.yaml", {
    command_plan: {
      ...
      commands: [
        "node harness-core/tools/run_openai_redteam_limited_execution.mjs",
        "node harness-core/tools/check_openai_redteam_limited_execution.mjs"
      ],
...
function writeDocs(status) {
  const docs = {
    "docs/openai_redteam_limited_execution_preflight.md": `# OpenAI Redteam Limited Execution Preflight
...
`,
    "docs/openai_redteam_limited_execution_approval_request.md": readText(p("release", "openai_redteam_limited_execution_approval_request.md")),
    "docs/openai_redteam_limited_execution_commands.md": `# OpenAI Redteam Limited Execution Commands
...
- OPENAI_MODEL
`,
    "docs/next_openai_redteam_limited_execution_after_approval.md": `# Next OpenAI Redteam Limited Execution After Approval
...
const commandPlanGenerated = fileExists("release/openai_redteam_limited_execution_command_plan.yaml");
const report = {
  status,
  stage: STAGE,
  design_only: true,
