...
const SELF_CONTAINED_COMMAND = "node tools/check_agent_ready_self_contained.mjs";
const REFERENCE_BASELINE_COMMAND = "node tools/check_reference_baseline_integrity.mjs";
const CURRENT_STATE_ALIGNMENT_COMMAND = "node tools/check_current_state_alignment.mjs";
const FINAL_PRECOMMIT_COMMAND = "node tools/check_harness_core_final_precommit_convergence.mjs";
...
function rootVsExportCommandSurface() {
  const docs = COMMAND_DOCS.map((entry) => {
    ...
    return {
      ...
      export_reference_baseline_command_present: entry === "docs/harness_core_final_precommit_convergence.ko.md"
...
function schemaAlignment() {
  ...
  addCheck(checks, "required files use reference baseline checker", requiredInputs.includes("tools/check_reference_baseline_integrity.mjs"), { required_input_count: requiredInputs.length });
...
const selfContained = runNode("tools/check_agent_ready_self_contained.mjs");
const referenceBaseline = runNode("tools/check_reference_baseline_integrity.mjs");
const currentStateAlignment = runNode("tools/check_current_state_alignment.mjs");
const noLegacySurface = runNode("tools/check_harness_core_no_legacy_surface.mjs");
const gitReadiness = runNode("tools/check_harness_core_git_readiness.mjs");
const cleanExportCheck = runNode("tools/check_clean_export_self_contained.mjs");
const validateAlpha = runNode("tools/validate_alpha.mjs");
const scanProhibitedClaims = runNode("tools/scan_prohibited_claims.mjs");
...
const referenceBaselineFinalReport = {
  ...
  stage: STAGE,
  generated_at: generatedAt,
  source_checker: "tools/check_reference_baseline_integrity.mjs",
...
const cleanExportFinalReport = {
  ...
  stage: STAGE,
  generated_at: generatedAt,
  source_checker: "tools/check_clean_export_self_contained.mjs",
...
const gitFinalReadinessReport = {
  ...
  stage: STAGE,
  generated_at: generatedAt,
  source_checker: "tools/check_harness_core_git_readiness.mjs",
