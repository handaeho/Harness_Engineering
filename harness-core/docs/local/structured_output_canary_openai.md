...
```powershell
node harness-core/tools/runners/openai/run_openai_structured_output_canary.mjs
node harness-core/tools/checks/openai/check_openai_structured_output_canary.mjs
```
