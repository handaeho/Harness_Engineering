...
```powershell
node harness-core/tools/runners/openai/run_openai_tool_calling_canary.mjs --attempt-id=002-tool-calling-replay-rerun
node harness-core/tools/comparisons/evals/compare_tool_calling_replay_attempts.mjs
node harness-core/tools/checks/openai/check_openai_tool_calling_replay_rerun.mjs
```
