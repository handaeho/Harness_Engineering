...
- canonical reference checker: `node tools/checks/workspace/check_reference_baseline_integrity.mjs`
- no-legacy surface checker: `node tools/checks/workspace/check_harness_core_no_legacy_surface.mjs`
- git readiness checker: `node tools/checks/workspace/check_harness_core_git_readiness.mjs`
