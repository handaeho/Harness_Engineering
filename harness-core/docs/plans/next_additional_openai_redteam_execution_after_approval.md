...
```sh
node harness-core/tools/runners/openai/run_additional_openai_redteam_execution.mjs --approval-phrase="I explicitly approve v2.0.0-beta-additional-openai-redteam-execution"
