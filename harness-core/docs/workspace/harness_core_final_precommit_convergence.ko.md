...
`node tools/checks/workspace/check_current_state_alignment.mjs`와 `node tools/checks/workspace/check_harness_core_final_precommit_convergence.mjs`는 root workspace 전용이다.
