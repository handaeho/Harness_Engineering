...
```text
node harness-core/tools/run_openai_structured_output_canary.mjs --attempt-id=002-structured-output-replay-rerun
node harness-core/tools/compare_openai_structured_output_replay_attempts.mjs
```
