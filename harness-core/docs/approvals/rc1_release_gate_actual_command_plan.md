# RC1 Release Gate Actual Command Plan

command_plan:
  stage_to_execute_after_approval: v2.0.0-rc.1-release-gate-actual-openai-scope

  required_approval_phrase: "I explicitly approve v2.0.0-rc.1-release-gate-actual-openai-scope"
