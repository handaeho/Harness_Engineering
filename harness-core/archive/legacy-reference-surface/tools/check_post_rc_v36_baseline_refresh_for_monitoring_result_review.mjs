...
const baselineStatus = gitStatus(["harness-core/evidence/v36-baseline"]);
addCheck(checks, "evidence/v36-baseline changed under owner-approved refresh",
  baselineStatus.exit_code === 0 && baselineStatus.stdout.includes("harness-core/evidence/v36-baseline"), baselineStatus);
