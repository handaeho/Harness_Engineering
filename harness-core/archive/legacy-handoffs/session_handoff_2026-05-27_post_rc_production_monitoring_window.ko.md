...
Working root: `C:\WORK\0.개인\HARNESS\harness-core`
...
```bash
cd C:\WORK\0.개인\HARNESS\harness-core
...
```bash
node tools/check_post_rc_production_monitoring_window_continuation.mjs
git status --short -- prompt-stack/v36 dist harness-core/evidence/v36-baseline
```
...
```text
harness-core/POST_RC_WORK_SEQUENCE_TEMP.ko.md
harness-core/original_order.txt
...
```text
작업 대상은 C:\WORK\0.개인\HARNESS\harness-core입니다.
