...
function writeStaticArtifacts() {
  writeRelText("release/post_rc_telemetry_connection_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_telemetry_connection_claim_boundary.yaml", `stage: ${STAGE}
conditional_claim:
  telemetry-connected:
...
`);
  ...
  writeRelText("release/post_rc_telemetry_connection_blocker_update.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("docs/post_rc_telemetry_connection.md", `# Post-RC Telemetry Connection
...
`);
  ...
  writeRelText("docs/next_telemetry_connected_claim_review.md", `# Next Telemetry-Connected Claim Review
...
const dependencyResults = {
  ...
  compare_v36_baseline: runNodeScript("compare_v36_baseline.mjs", "compare_v36_baseline.mjs pass"),
...
for (const relPath of [
  "release/post_rc_telemetry_connection_scope.yaml",
  "release/post_rc_telemetry_connection_claim_boundary.yaml",
  "release/post_rc_telemetry_connection_blocker_update.yaml",
  "tools/run_post_rc_telemetry_connection.mjs",
  "tools/check_post_rc_telemetry_connection.mjs",
  "tools/audit_post_rc_telemetry_connection_claims.mjs",
  ...
  "docs/post_rc_telemetry_connection.md",
  "docs/post_rc_telemetry_connection_result_review.md",
  "docs/next_telemetry_connected_claim_review.md"
]) {
