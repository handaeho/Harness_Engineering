...
function runnerContractYaml() {
  ...
  runner_to_create_in_execution_stage:
    - tools/run_dedicated_containment_verification.mjs
    - tools/check_dedicated_containment_verification.mjs
...
function commandPlanYaml() {
  ...
  commands:
    - node prompt-stack-v2/tools/run_dedicated_containment_verification.mjs
    - node prompt-stack-v2/tools/check_dedicated_containment_verification.mjs
...
function readmeText() {
  return buildMarkdown("Prompt Stack v2", [
    ...
    "",
    "```powershell",
    "node prompt-stack-v2/tools/check_dedicated_containment_verification_plan.mjs",
    "```",
    "",
...
function handoffText(report) {
  return buildMarkdown("Session Handoff - 2026-05-22", [
    ...
    "## Current Snapshot",
    "",
    "- Workspace root: repository parent directory containing `prompt-stack-v2/`; do not assume an OS-specific absolute path.",
    "- Active project path: `prompt-stack-v2/` relative to the workspace root.",
    ...
    "- `prompt-stack/v36/**` modification status: false by latest checksum comparison.",
    "- `prompt-stack-v2/dist/**` modification status: false; only `dist/README.md` is present.",
    "",
    ...
    "",
    "- `node prompt-stack-v2/tools/build_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node prompt-stack-v2/tools/validate_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node prompt-stack-v2/tools/check_dedicated_containment_verification_plan.mjs`: pass.",
    "- `node prompt-stack-v2/tools/validate_alpha.mjs`: pass.",
    "- `node prompt-stack-v2/tools/scan_prohibited_claims.mjs`: pass, matches 0.",
    "- `node prompt-stack-v2/tools/compare_v36_baseline.mjs`: pass.",
    "",
...
function docFiles() {
  return {
    "docs/dedicated_containment_verification_plan.md": buildMarkdown("Dedicated Containment Verification Plan", [
    ...
    "docs/dedicated_containment_runner_contract.md": buildMarkdown("Dedicated Containment Runner Contract", [
    ...
    "docs/dedicated_containment_acceptance_criteria.md": buildMarkdown("Dedicated Containment Acceptance Criteria", [
    ...
    "docs/containment_risk_acceptance_policy.md": buildMarkdown("Containment Risk Acceptance Policy", [
      "Risk acceptance policy is drafted only.",
      "",
      "Risk acceptance does not unlock `containment-verified` or `production-ready`."
    ]),
    "docs/next_dedicated_containment_verification_execution.md": buildMarkdown("Next Dedicated Containment Verification Execution", [
    ...
    "docs/next_release_blocker_resolution_plan.md": buildMarkdown("Next Release Blocker Resolution Plan", [
