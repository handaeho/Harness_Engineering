...
const REQUIRED_FILES = [
  "release/post_rc_production_monitoring_values_owner_preflight_scope.yaml",
  "release/post_rc_production_monitoring_values_owner_gate.yaml",
  "release/post_rc_production_monitoring_window_preconditions.yaml",
  "release/post_rc_production_monitoring_values_approval_request.md",
  "release/post_rc_production_monitoring_window_command_plan.yaml",
  ...
  "docs/production_monitoring_values_owner_preflight.md",
  "docs/production_monitoring_operator_values_template.md",
  "docs/production_monitoring_recommended_defaults.md",
  "docs/production_monitoring_window_execution_plan.md",
  "docs/production_monitoring_values_approval_request.md",
...
const commandPlan = readYamlIfExists("release/post_rc_production_monitoring_window_command_plan.yaml");
...
addCheck(checks, "command plan is not executable in this stage",
  commandPlan?.command_plan?.stage_to_execute_after_operator_values === "v2.0.0-post-rc-production-monitoring-window-execution"
    ...
    && commandPlan?.command_plan?.commands?.includes("node prompt-stack-v2/tools/run_post_rc_production_monitoring_window.mjs")
    && commandPlan?.command_plan?.commands?.includes("node prompt-stack-v2/tools/check_post_rc_production_monitoring_window.mjs"), {
...
addCheck(checks, "window execution scripts were not created",
  !exists("tools/run_post_rc_production_monitoring_window.mjs")
    && !exists("tools/check_post_rc_production_monitoring_window.mjs"), {
  run_script_exists: exists("tools/run_post_rc_production_monitoring_window.mjs"),
  check_script_exists: exists("tools/check_post_rc_production_monitoring_window.mjs")
});
