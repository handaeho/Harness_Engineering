...
import {
  ...
  resolveRoot
} from "./run_rc1_release_gate_dry_run_openai_scope.mjs";
...
for (const relPath of [
  ...requiredRc1BundleFiles,
  "release/rc1_release_gate_dry_run_openai_scope_scope.yaml",
  "release/rc1_release_gate_dry_run_openai_scope.yaml",
  "release/rc1_openai_scope_release_decision_draft.yaml",
  "release/rc1_local_endpoint_deferred_policy.yaml",
  "release/rc1_strict_provider_diverse_deferred_policy.yaml",
  "release/rc1_release_gate_actual_preconditions.yaml",
  "tools/run_rc1_release_gate_dry_run_openai_scope.mjs",
  "tools/audit_rc1_release_gate_claim_boundaries.mjs",
  "tools/summarize_rc1_release_gate_readiness.mjs",
  "tools/check_rc1_release_gate_dry_run_openai_scope.mjs",
  ...
  "docs/rc1_release_gate_dry_run_openai_scope.md",
  "docs/rc1_release_gate_claim_boundary.md",
  "docs/rc1_local_endpoint_deferred.md",
  "docs/rc1_provider_diversity_deferred.md",
  "docs/rc1_release_gate_actual_preconditions.md",
  "docs/next_rc1_release_gate_actual_plan.md",
