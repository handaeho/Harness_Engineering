...
approved_actions:
  ...
  v36_baseline_refresh_worktree_status_recording: true
...
const approvedRefreshFiles = baselineStatus.stdout
  ...
  .filter((file) => file === "prompt-stack-v2/evidence/v36-baseline/checksums.json"
...
const v36WorktreeStatus = {
  status: "recorded",
  compare_v36_baseline_status: finalGate.compare_v36_baseline_status === "pass" ? "pass" : "unknown",
  v36_modified: false,
  dist_modified: false,
...
writeJsonSafe(e("v36_baseline_refresh_worktree_status.json"), v36WorktreeStatus);
