...
import {
  ...
  evidenceRelDir,
  resolveRoot
} from "./run_rc1_release_gate_actual_openai_scope.mjs";
...
addCheck("compare_v36_baseline.mjs pass", baseline.ok, {
...
for (const relPath of [
  "release/rc1_release_gate_actual_openai_scope_scope.yaml",
  "release/rc1_release_gate_actual_approval_record.json",
  "release/rc1_release_gate_actual_openai_scope.yaml",
  "release/rc1_release_gate_actual_blocker_update.yaml",
  "release/rc1_release_gate_actual_claim_boundary.yaml",
  "release/rc1_local_endpoint_deferred_final.yaml",
  "release/rc1_provider_diversity_deferred_final.yaml",
  "release/rc1_release_decision_record.yaml",
  "release/rc1_release_decision_record.json",
  "tools/run_rc1_release_gate_actual_openai_scope.mjs",
  "tools/check_rc1_release_gate_actual_openai_scope.mjs",
  "tools/audit_rc1_release_gate_actual_claims.mjs",
  "tools/summarize_rc1_release_gate_actual_result.mjs",
  ...
  "docs/rc1_release_gate_actual_openai_scope.md",
  "docs/rc1_release_gate_actual_claim_boundary.md",
  "docs/rc1_release_decision_record.md",
  "docs/rc1_not_stable_final_notice.md",
...
addCheck("v36 modified false", baseline.ok, {
  status: baseline.detail.status,
  v36_modified: false
});
