...
function writeStaticArtifacts() {
  writeRelText("release/post_rc_production_monitoring_window_continuation_checkpoint_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_continuation_gate.yaml", `stage: ${STAGE}
gate_script: tools/check_post_rc_production_monitoring_window_continuation.mjs
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_continuation_blocker_update.yaml", `stage: ${STAGE}
status: updated
...
gate:
  script: tools/check_post_rc_production_monitoring_window_continuation.mjs
expected_status:
  - pass
  - ready_for_monitoring_window_result_review
`);

  writeRelText("docs/production_monitoring_window_continuation_checkpoint.md", `# Production Monitoring Window Continuation Checkpoint
...
`);
  ...
  writeRelText("docs/production_monitoring_window_remaining_requirements.md", `# Production Monitoring Window Remaining Requirements
...
`);
  ...
  writeRelText("docs/next_monitoring_window_result_review_plan.md", `# Next Monitoring Window Result Review Plan
