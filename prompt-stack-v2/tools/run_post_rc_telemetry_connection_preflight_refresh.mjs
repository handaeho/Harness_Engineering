...
`);
  ...
  writeYaml("release/post_rc_operator_sequence_record_scope.yaml", {
    stage: SEQUENCE_STAGE,
    document_path: "POST_RC_WORK_SEQUENCE_TEMP.ko.md",
    document_language: "ko",
    telemetry_first: true,
...
function writeLocalEndpointFutureArtifacts() {
  write("docs/local_endpoint_future_integration.ko.md", `# Local Endpoint Future Integration 계획
...
`);
  ...
  write("docs/local_endpoint_future_unit_integration_verification.ko.md", `# Local Endpoint 향후 단위/통합 검증 계획
...
`);
  ...
  write("docs/local_endpoint_operator_handoff_template.ko.md", `# Local Endpoint 준비 완료 전달 템플릿
...
`);
  writeJsonRel("evidence/post-rc-local-endpoint-future-integration/local_endpoint_future_verification_plan.json", {
    status: "recorded",
    stage: LOCAL_STAGE,
    unit_verification_document: "docs/local_endpoint_future_unit_integration_verification.ko.md",
    current_goal_runs_local_endpoint: false,
    local_endpoint_probe_allowed_now: false,
    local_model_execution_allowed_now: false,
    future_operator_signal_required: true,
...
See docs/local_endpoint_operator_handoff_template.ko.md.
...
- future_operator_signal_required: true
`);
  writeYaml("release/post_rc_local_endpoint_future_integration_policy.yaml", {
    policy: {
      stage: LOCAL_STAGE,
...
function writeTelemetryPreflightArtifacts() {
  ...
  writeYaml("release/post_rc_telemetry_connection_preflight_refresh_scope.yaml", {
    stage: STAGE,
    preflight_only: true,
    approved_actions: {
  ...
  writeYaml("release/post_rc_telemetry_connection_approval_gate.yaml", {
    approval_gate: {
      stage: STAGE,
  ...
  write("release/post_rc_telemetry_connection_approval_request.md", `# Post-RC Telemetry Connection Approval Request
...
`);
  const commandPlan = {
    command_plan: {
      ...
      commands: [
        "node prompt-stack-v2/tools/run_post_rc_telemetry_connection.mjs",
        "node prompt-stack-v2/tools/check_post_rc_telemetry_connection.mjs"
      ],
  ...
  writeYaml("release/post_rc_telemetry_connection_command_plan.yaml", commandPlan);
  writeYaml("release/post_rc_telemetry_local_endpoint_deferred_confirmation.yaml", {
...
`);
  ...
  write("docs/post_rc_telemetry_connection_preflight_refresh.md", `# Post-RC Telemetry Connection Preflight Refresh
...
- blocked: stable
`);
  write("docs/post_rc_telemetry_connection_approval_request.md", `# Post-RC Telemetry Connection Approval Request
...
`);
  write("docs/post_rc_telemetry_connection_command_plan.md", `# Post-RC Telemetry Connection Command Plan
