...
checks:
  ...
  - v36_baseline_refresh_gate_pass
...
const refreshGateReport = readJsonIfExists("evidence/post-rc-v36-baseline-refresh-for-monitoring-result-review/post_rc_v36_baseline_refresh_gate_report.json") || {};
...
const v36AndDistClean = forbiddenStatus.exit_code === 0 && forbiddenStatus.stdout === "";
const ownerApprovedBaselineRefreshPresent = readJsonIfExists("evidence/post-rc-v36-baseline-refresh-for-monitoring-result-review/v36_baseline_refresh_report.json")?.status === "pass";
...
const v36Ready = compare.status === "pass" && refreshGateStatus === "pass";
...
const pass = evidenceReady && resultReviewReady && v36Ready && redactionReady && thresholdReady && incidentReady && v36AndDistClean && baselineChangeAllowed;
...
const preconditionReview = {
  ...
  v36_baseline_refresh_gate_status: refreshGateStatus,
  final_gate_preconditions_ready: evidenceReady,
  v36_and_dist_clean: v36AndDistClean,
...
const report = {
  ...
  evidence_v36_baseline_modified_by_prior_owner_approved_refresh: baselineStatus.stdout !== "" && ownerApprovedBaselineRefreshPresent,
...
const evidenceSummary = {
  ...
  compare_v36_baseline_status: report.compare_v36_baseline_status,
  v36_owner_approved_refresh_effective: ownerApprovedBaselineRefreshPresent,
  openai_model_api_call: false,
  local_endpoint_probe: false,
  local_model_execution: false,
  telemetry_sink_write: false
...
const requiredEvidence = {
  ...
  v36_baseline_refresh_for_monitoring_result_review: ownerApprovedBaselineRefreshPresent
};
...
const decisionRecord = {
  ...
  rationale: [
    ...
    "v36 baseline dependency resolved by owner-approved refresh"
  ]
};
