...
const dashboard = {
  ...
  lanes: {
    openai_limited_redteam_execution: {
      ...
      command_plan: "release/openai_redteam_limited_execution_command_plan.yaml",
    ...
    production_telemetry_connection: {
      ...
      command_plan: "release/production_telemetry_connection_command_plan.yaml",
      can_execute_now: false,
      claims_unlocked_after_success_candidate: [
...
const commandPlanIndex = {
  command_plans: [
    {
      lane: "openai_limited_redteam_execution",
      command_plan_path: "release/openai_redteam_limited_execution_command_plan.yaml",
    ...
    {
      lane: "production_telemetry_connection",
      command_plan_path: "release/production_telemetry_connection_command_plan.yaml",
      currently_executable: false
    },
    {
      lane: "local_no_tool_canary",
      command_plan_path: "docs/next_local_canary_plan.md",
      currently_executable: false
    }
  ]
};
...
writeYaml("release/beta_execution_readiness_dashboard_scope.yaml", {
  stage: STAGE,
  approved_actions: {
...
writeYaml("release/execution_readiness_gate.yaml", {
...
writeYaml("release/next_execution_decision_matrix.yaml", decisionMatrix);
writeYaml("release/blocked_execution_lanes.yaml", blockedExecutionLanes);
writeYaml("release/approval_phrase_index.yaml", approvalPhraseIndex);
writeYaml("release/environment_requirement_index.yaml", environmentRequirementIndex);
writeYaml("release/command_plan_index.yaml", commandPlanIndex);
writeYaml("release/claim_impact_matrix.yaml", claimImpactMatrix);
