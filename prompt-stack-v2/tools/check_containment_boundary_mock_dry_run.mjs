...
const designGate = runJsonTool("tools/check_containment_boundary_verification_design.mjs");
const summaryTool = runJsonTool("tools/summarize_containment_boundary_mock_results.mjs");
