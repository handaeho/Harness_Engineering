...
export function resolveRoot(argv = process.argv) {
  ...
  if (path.basename(cwd) === "prompt-stack-v2") return cwd;
  const child = path.join(cwd, "prompt-stack-v2");
...
function commandPlanYaml() {
  ...
  commands:
    - node prompt-stack-v2/tools/run_rc1_release_gate_actual_openai_scope.mjs
    - node prompt-stack-v2/tools/check_rc1_release_gate_actual_openai_scope.mjs
...
\`\`\`powershell
node tools/check_rc1_release_gate_actual_preflight_openai_scope.mjs C:\\WORK\\0.개인\\HARNESS\\prompt-stack-v2
\`\`\`
`;
}
...
Current working root: \`C:\\WORK\\0.개인\\HARNESS\\prompt-stack-v2\`
...
- Work only under \`C:\\WORK\\0.개인\\HARNESS\\prompt-stack-v2\`.
- Do not use \`C:\\WORK\\0.개인\\PROMPT\`.
- Do not modify \`dist/**\`.
