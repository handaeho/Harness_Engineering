...
function yamlCommandPlanHasFutureOnly(relPath) {
  ...
  return plan?.not_executable_in_preflight_refresh_stage === true
    ...
    && plan.commands.includes("node prompt-stack-v2/tools/run_post_rc_telemetry_connection.mjs")
    && plan.commands.includes("node prompt-stack-v2/tools/check_post_rc_telemetry_connection.mjs");
}
...
const baseline = runJsonTool("compare_v36_baseline.mjs");
addCheck(checks, "compare_v36_baseline.mjs pass", baseline.ok, {
...
for (const relPath of [
  ...
  "release/post_rc_telemetry_connection_preflight_refresh_scope.yaml",
  "release/post_rc_telemetry_connection_approval_gate.yaml",
  "release/post_rc_telemetry_connection_approval_request.md",
  "release/post_rc_telemetry_connection_command_plan.yaml",
  "release/post_rc_telemetry_local_endpoint_deferred_confirmation.yaml",
  "docs/post_rc_telemetry_connection_preflight_refresh.md",
  "docs/post_rc_telemetry_connection_approval_request.md",
  "docs/post_rc_telemetry_connection_command_plan.md",
...
const actualTelemetryStageImplemented = exists("release/post_rc_telemetry_connection_scope.yaml")
  && exists("tools/run_post_rc_telemetry_connection.mjs")
  && exists("tools/check_post_rc_telemetry_connection.mjs");
addCheck(checks, "actual telemetry runner boundary remains controlled",
  !exists("tools/run_post_rc_telemetry_connection.mjs") || actualTelemetryStageImplemented, {
  runner_exists: exists("tools/run_post_rc_telemetry_connection.mjs"),
  actualTelemetryStageImplemented
});
addCheck(checks, "actual telemetry checker boundary remains controlled",
  !exists("tools/check_post_rc_telemetry_connection.mjs") || actualTelemetryStageImplemented, {
  checker_exists: exists("tools/check_post_rc_telemetry_connection.mjs"),
  actualTelemetryStageImplemented
});
...
addCheck(checks, "future command plan recorded only",
  yamlCommandPlanHasFutureOnly("release/post_rc_telemetry_connection_command_plan.yaml")
...
addCheck(checks, "git status clean for v36/dist/evidence-v36-baseline", forbiddenStatus.exit_code === 0 && forbiddenStatus.stdout === "", forbiddenStatus);
...
const report = {
  ...
  dependency_results: {
    ...
    compare_v36_baseline: baseline.detail.status,
