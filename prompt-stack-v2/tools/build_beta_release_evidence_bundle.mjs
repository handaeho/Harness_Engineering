...
const sections = [
  {
    section_id: "v36_baseline",
    status: exists("evidence/v36-baseline/checksums.json") ? "pass" : "missing",
    claim_level: "baseline_snapshot",
    artifacts: collectArtifacts("evidence/v36-baseline", ["checksums.json", "file_inventory.json"])
  },
  {
    section_id: "alpha",
