...
import { buildReleaseBlockerReevaluationArtifacts, resolveRoot, STAGE } from "./reevaluate_release_blockers.mjs";
...
for (const relPath of [
  "release/beta_release_blocker_p0_p1_reevaluation_scope.yaml",
  "release/release_blocker_p0_p1_current.yaml",
  "release/rc1_readiness_assessment.yaml",
  "release/release_path_decision_matrix.yaml",
  "release/openai_only_rc_path.yaml",
  "release/strict_provider_diverse_rc_path.yaml",
  "tools/reevaluate_release_blockers.mjs",
  "tools/summarize_rc1_readiness.mjs",
  "tools/audit_release_claim_boundaries_after_containment.mjs",
  "tools/check_release_blocker_p0_p1_reevaluation.mjs",
...
- Gate script: \`prompt-stack-v2/tools/check_release_blocker_p0_p1_reevaluation.mjs\`
