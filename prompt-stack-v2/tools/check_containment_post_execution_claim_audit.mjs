...
import { buildPostExecutionAuditArtifacts, resolveRoot, STAGE } from "./review_dedicated_containment_results.mjs";
...
for (const relPath of [
  "release/beta_containment_post_execution_claim_audit_scope.yaml",
  "release/containment_post_execution_owner_review_draft.yaml",
  "release/containment_post_execution_blocker_update.yaml",
  "release/containment_claim_decision_draft.yaml",
  ...
  "tools/review_dedicated_containment_results.mjs",
  "tools/audit_dedicated_containment_claims.mjs",
  "tools/summarize_containment_post_execution_evidence.mjs",
  "tools/check_containment_post_execution_claim_audit.mjs",
