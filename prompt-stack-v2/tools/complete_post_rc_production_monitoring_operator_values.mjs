...
const operatorValuesYaml = `operator_values:
  ...
  dashboard:
    langfuse_project_name: "prompt-stack-v2-post-rc"
...
function writeReleaseArtifacts() {
  writeRelText("release/post_rc_production_monitoring_operator_values_completion_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("release/post_rc_production_monitoring_window_execution_approval_gate.yaml", `stage: ${STAGE}
...
- local-model-verified
`;
  writeRelText("release/post_rc_production_monitoring_window_execution_approval_request.md", approvalRequest);
  writeRelText(`${EVIDENCE_DIR}/production_monitoring_window_execution_approval_request.md`, approvalRequest);
  writeRelText("docs/production_monitoring_window_execution_approval_request.md", approvalRequest);
...
forbidden_execution:
  ...
  local_model_execution: true
gate:
  script: tools/check_post_rc_production_monitoring_operator_values_completion.mjs
required_artifacts:
...
function writeDocs() {
  writeRelText("docs/production_monitoring_operator_values_completion.md", `# Production Monitoring Operator Values Completion
