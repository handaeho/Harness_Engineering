...
import { buildRc1OpenAiScopeBundleArtifacts, rc1ClaimsAllowed, rc1ClaimsBlocked, resolveRoot, STAGE } from "./build_rc1_openai_scope_bundle.mjs";
...
for (const relPath of [
  "release/rc1_openai_scope_bundle_scope.yaml",
  "release/rc1_openai_scope_release_candidate.yaml",
  "release/rc1_claim_boundary.yaml",
  "release/rc1_blocker_snapshot.yaml",
  "release/rc1_release_gate_readiness.yaml",
  "release/rc1_not_stable_notice.yaml",
  "tools/build_rc1_openai_scope_bundle.mjs",
  "tools/summarize_rc1_evidence_lineage.mjs",
  "tools/audit_rc1_claim_boundaries.mjs",
  "tools/generate_rc1_bundle_manifest.mjs",
  "tools/check_rc1_openai_scope_bundle.mjs",
  ...
  "docs/rc1_openai_scope_bundle.md",
  "docs/rc1_evidence_lineage.md",
  "docs/rc1_claim_boundary.md",
  "docs/rc1_remaining_blockers.md",
  "docs/rc1_not_stable_notice.md",
  "docs/next_release_gate_actual_plan.md",
  "docs/next_strict_provider_diverse_path.md",
  "docs/next_local_canary_plan.md",
  "docs/next_telemetry_connection_plan.md"
]) {
...
addCheck(checks, "no new execution flags remain false", summary?.new_provider_execution === false
  ...
  v36_modified: summary?.v36_modified
});
...
addCheck(checks, "v36 modified false", baseline.ok, {
  status: baseline.detail.status,
  v36_modified: false
});
