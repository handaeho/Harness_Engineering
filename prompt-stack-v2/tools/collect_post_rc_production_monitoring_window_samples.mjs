...
function writeStaticArtifacts() {
  writeRelText("release/post_rc_production_monitoring_window_sample_collection_scope.yaml", `stage: ${STAGE}
...
`);
  ...
  writeRelText("docs/production_monitoring_window_sample_collection.md", `# Production Monitoring Window Sample Collection
