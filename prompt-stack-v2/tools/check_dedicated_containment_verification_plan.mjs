...
import { validatePlan } from "./validate_dedicated_containment_verification_plan.mjs";
...
const storageGate = runJsonTool("tools/check_cross_suite_storage_redaction_audit.mjs");
...
addCheck(checks, "future execution runner absent", !exists("tools/run_dedicated_containment_verification.mjs")
