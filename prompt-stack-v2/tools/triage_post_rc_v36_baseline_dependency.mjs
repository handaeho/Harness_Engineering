...
function buildHashComparison(compareReport) {
  ...
  return {
    ...
    baseline_path: "prompt-stack-v2/evidence/v36-baseline/checksums.json",
...
const currentCompareSnapshot = {
  ...
  notes: [
    ...
    "Mismatch is between current prompt-stack/v36 files and prompt-stack-v2/evidence/v36-baseline/checksums.json."
  ]
};
...
const v36Guardrail = {
  ...
  evidence_v36_baseline_dirty: guardrailModified.some((line) => line.includes("prompt-stack-v2/evidence/v36-baseline")),
...
const decisionRequest = {
  ...
  reason: ownerDecisionRequired
    ? "Current v36 files differ from prompt-stack-v2/evidence/v36-baseline while guardrail paths are clean; refreshing or restoring the baseline requires owner approval."
